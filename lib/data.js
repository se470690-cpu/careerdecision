...
export const INDUSTRIES = ['플랫폼', '커머스', '핀테크', '푸드테크', '모빌리티', '게임', '엔터·콘텐츠', '엔터프라이즈'];
...
export const COMPANIES = [
  ...
  { id: 'woowa', name: '우아한형제들', area: '잠실·송파', lat: 37.5118, lng: 127.1088, addr: '서울 송파구 석촌호수 인근 (2028 잠실 신사옥 이전 예정 보도)', v: 0, office: 2, note: '주 2회 출근 의무, 신사옥 이전 후 주 3회 예정(보도 기준)', ind: '푸드테크', careers: 'https://career.woowahan.com/', collect: 'none', collectNote: '공식 채용 사이트가 JavaScript 전용이라 서버에서 읽을 수 없음' },
